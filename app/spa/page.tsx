...
export default function SpaPage() {
  ...
  return (
    <main className="min-h-screen">
      ...
      <PageHeader
        title="Wellness Spa"
        description="Immerse yourself in ultimate luxury and tranquility"
        image="/images/spa-bg.jpg"
      />

      <div className="container mx-auto px-4 py-16">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <h2 className="text-3xl font-playfair mb-4">A Haven of Relaxation</h2>
          <p className="text-lg text-gray-700">
            The Spa is the place to be pampered after a day of outdoor adventure. For the ultimate spa experience,
            immerse yourself in ultimate luxury and tranquility. Built on 1,200 sqm our Wellness centre has different
            saunas, an indoor heated pool, Garden, and a state of the art Gym.
          </p>
        </div>

        {/* Spa Facilities */}
        <div className="mb-20">
          <h2 className="text-3xl font-playfair text-center mb-12">Spa Facilities</h2>
        ...
        {/* Spa Treatments */}
        <div className="mb-16">
          <h2 className="text-3xl font-playfair text-center mb-12">Spa Treatments</h2>
          ...
          <div className="text-center mt-10">
            <Button size="lg">Book a Treatment</Button>
          </div>
        </div>

        {/* Spa Packages */}
        <div className="bg-white rounded-lg shadow-md p-8 mb-16">
          <h2 className="text-3xl font-playfair text-center mb-6">Spa Packages</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="border border-gray-200 rounded-lg p-6 text-center">
              <h3 className="text-xl font-playfair mb-2">Relaxation Journey</h3>
              ...
              <p className="text-lg font-medium mb-4">€220 per person</p>
            ...
            <div className="border border-primary rounded-lg p-6 text-center bg-primary/5 relative">
              ...
              <h3 className="text-xl font-playfair mb-2">Complete Wellness</h3>
              <p className="text-sm text-gray-500 mb-4">5 hours</p>
              <ul className="text-gray-700 mb-6 space-y-2">
                <li>Welcome Ritual</li>
              ...
              <p className="text-lg font-medium mb-4">€340 per person</p>
              <Button className="w-full">Book Now</Button>
            </div>
            <div className="border border-gray-200 rounded-lg p-6 text-center">
              <h3 className="text-xl font-playfair mb-2">Couples Escape</h3>
              <p className="text-sm text-gray-500 mb-4">4 hours</p>
              <ul className="text-gray-700 mb-6 space-y-2">
              ...
              <p className="text-lg font-medium mb-4">€480 per couple</p>
              <Button variant="outline" className="w-full">
                Book Now
              </Button>
            </div>
