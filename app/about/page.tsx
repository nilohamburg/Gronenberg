...
export default function AboutPage() {
  ...
  return (
    <main className="min-h-screen">
      <Navbar />
      <PageHeader
        title="About Gronenberger Mühle"
        description="A historic landmark reimagined as a luxury retreat"
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        {/* Timeline */}
        <div className="max-w-4xl mx-auto mb-20">
          <h2 className="text-3xl font-playfair text-center mb-12">Our History</h2>
        ...
        <div className="max-w-4xl mx-auto mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-playfair mb-3">Hospitality</h3>
